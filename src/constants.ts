...
export const EXPERIENCES: ExperienceData[] = [
  {
    ...
    paragraphs: [
      "Serving as the first Engineering Manager at Ravn, a software consultancy, building the role and its frameworks from scratch. Leading a cross-functional team across multiple concurrent client engagements simultaneously, each with distinct tech stacks and stakeholder dynamics. Current projects span BLE/WiFi-connected hardware with mobile apps (React Native, Expo SDK 54), backend services (NestJS, GraphQL), and cloud infrastructure.",
      "Day-to-day work combines hands-on technical context with structured people management: running regular 1:1s, shaping team processes, and serving as the bridge between engineers, product managers, and client stakeholders. Beyond client delivery, facilitating Ravn's internal Labs program, a structured cohort initiative focused on AI adoption and engineering capability growth across the organization.",
      "Separately, building the foundational frameworks that define the EM function at Ravn in close collaboration with the Head of Engineering: engineering health metrics grounded in DORA research (from Accelerate), RACI-based role definitions, and evaluation rubrics using a BARS-based scoring system for both individual and team performance. Also leading structured AI adoption initiatives across the organization, conducting 1:1 calls with teams to assess and accelerate their use of AI tooling in their workflows.",
    ],
    shortText:
  ...
  },
  {
    ...
    tags: ["React", "Pixel-Perfect", "HTML", "CSS"],
    paragraphs: [
      "Selected for Isobar's acceleration program (Future Face), a competitive initiative designed to fast-track junior developers into production-ready engineers. Worked as a frontend developer in a small team on two tracks: an internal project involving Spotify API integration, and production-ready pixel-perfect websites for international marketing companies.",
  ...
  },
  {
    ...
    paragraphs: [
      "Part of SAP's Rotation Program at SAP Labs Latin America in São Leopoldo, working as a frontend developer on a farming portal that integrated with SAP's enterprise services. The portal helped farm owners track their products through the entire production chain, providing visibility from origin to delivery. Built the frontend using SAPUI5, supporting multiple devices and legacy browsers that were standard in agricultural operations.",
